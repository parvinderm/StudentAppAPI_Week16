...
public class StudentCRUDTest extends TestBase {
  ...
  static String firstName = "radhika"+ TestUtils.getRandomValue();
  static String lastName = "emily"+ TestUtils.getRandomValue();
  static String email = "radhe"+ TestUtils.getRandomValue()+ "@gmail.com";
  static String programme = "excel";
